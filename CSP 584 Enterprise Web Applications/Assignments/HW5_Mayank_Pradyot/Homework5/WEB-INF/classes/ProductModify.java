	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Add Product"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='wearabletech' selected>WearableTech</option><option value='laptops'>Laptop</option><option value='phones'>Phone</option><option value='voiceassistants'>VoiceAssistant</option></select>"
					+ "</td></tr><tr><td>"
		...
		// {
			...
			// pw.print("<table style='width:100%'>"
					...
					// +"<tr><td><h3>No of Products Available</h3></td><td>1</td></tr>"
					// + "</td></tr></table>");
			// }
