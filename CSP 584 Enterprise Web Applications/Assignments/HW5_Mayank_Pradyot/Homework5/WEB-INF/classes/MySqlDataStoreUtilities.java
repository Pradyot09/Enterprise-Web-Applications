...
public static void Insertproducts()
{
	try{
		...
		{   
			...
			System.out.print("voiceassistants");
		}
...
{	
	...
	try 
	{
		...
		String selectPhone="select * from  Productlist where ProductType=?";
...
{	
	...
	try 
	{
		...
		String selectVoiceAssistant="select * from  Productlist where ProductType=?";
		...
		System.out.print("voicesssistant");
	}
	catch(Exception e)
	{
	}
...
{	
	...
	try 
	{
		...
		String selectLaptop="select * from  Productlist where ProductType=?";
...
{	
	...
	try 
	{
		...
		String selectWearableTech="select * from  Productlist where ProductType=?";
