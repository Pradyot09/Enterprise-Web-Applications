...
public class DealMatchesUtilities extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<h2 class='title' style ='padding-top:10px'>Welcome to Smart Portables</h2>");
		
		pw.print("<div class='entry'>");
		pw.print("<img src='images/site/portables.jpg' style='width: 690px; display: block; margin-left: auto; margin-right: auto' />");
		
		pw.print("<h2>All kinds of portables available here</h2>");
		// pw.print("<br> <br>");
		...
		// pw.print("<h1>We beat our competitors in all aspects. Price-Match Guaranteed</h2>");
			...
			for(Map.Entry<String, Product> entry : productmap.entrySet())
			{
				...
				{		
					...
					BufferedReader reader = new BufferedReader(new FileReader (new File(TOMCAT_HOME+"\\webapps\\Homework5\\DealMatches.txt")));
		...
		pw.print("<ul>");
		pw.print("<li id='item'><img src='images/"+entry.getValue().getType()+"/"+entry.getValue().getImage()+"' alt='' style='width:150px;height:150px;'/>");
		pw.print("</li><li>");
