...
public class SubmitReview extends HttpServlet {
	...
	protected void storeReview(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    try
        {
			...
			String message=utility.storeReview(productname,producttype,productmaker,productonsale,manufacturerrebate,userage,usergender,useroccupation,reviewrating,reviewdate,reviewtext,retailerpin,productprice,retailercity);				     
