...
public class ManagerHome extends HttpServlet {
	...
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<form method='get' action='ProductModify'>"
				+"<br></br>"+"<table style='width:100%'><tr><td>"
				+ "<input type='submit' class='btnbuy' name='button' value='Addproduct'style = 'font-size:30px'></input>"
				+ "</td></tr><tr><td></td></tr><tr><td>"
				+ "<input type='submit' class='btnbuy' name='button' value='Updateproduct' style = 'font-size:30px'></input>"
				+ "</td></tr><tr><td></td></tr><tr><td>"
				+ "<input type='submit' class='btnbuy' name='button' value='Deleteproduct' style = 'font-size:30px'></input>"
				+ "</td></tr><tr><td></td></tr><tr><td>"
				+ "<input type='submit' class='btnbuy' name='button' value='Trending' style = 'font-size:30px'></input>"
				+ "</td></tr></table>"
