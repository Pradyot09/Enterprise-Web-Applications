	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='console' selected>Console</option><option value='games'>Games</option><option value='tablets'>Tablet</option><option value='accessories'>Accessory</option></select>"
					+ "</td></tr><tr><td>"
