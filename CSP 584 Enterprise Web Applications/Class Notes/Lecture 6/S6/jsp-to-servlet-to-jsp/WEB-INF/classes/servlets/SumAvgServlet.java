...
public class SumAvgServlet extends HttpServlet {
	...
	if(values == null) {
	    rd = sc.getRequestDispatcher("/jsp3/f13/sumavgform.jsp");
	    rd.forward(req,res);
	    return;
		...
		try {
		    ...
		    data.setBad(token);
		    rd = sc.getRequestDispatcher("/jsp3/f13/sumavgerror.jsp");
		    rd.forward(req,res);
		    return;
		}
	...
	rd = sc.getRequestDispatcher("/jsp3/f13/sumavgresults.jsp");
	rd.forward(req,res);
    }
}
